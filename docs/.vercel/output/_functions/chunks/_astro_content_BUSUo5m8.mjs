import { o as objectType, N as dateType, d as arrayType, s as stringType, O as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, P as escape, E as unescapeHTML, a as renderTemplate, Q as renderUniqueStylesheet, T as renderScriptElement, V as createHeadAndContent, r as renderComponent } from './astro/server_DUeoxbwr.mjs';
import { c as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_B8bFpEHO.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_BmVDRGlB.mjs';
import { u as unflatten } from './parse_C9KMzOH5.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Q2OWFg9j.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BoPjLhzM.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_bAHK3vX3.mjs');
