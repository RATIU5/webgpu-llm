import { $ as clientAddressSymbol, O as AstroError, a0 as LocalsNotAnObject, a1 as DEFAULT_404_COMPONENT, a2 as REROUTABLE_STATUS_CODES, a3 as REROUTE_DIRECTIVE_HEADER, a4 as responseSentSymbol, a5 as nodeRequestAbortControllerCleanupSymbol, a6 as getAugmentedNamespace, b as commonjsGlobal } from './astro/server_DUeoxbwr.mjs';
import { e as ensure404Route } from './astro-designed-error-pages_D5jU5H-U.mjs';
import { l as levels, g as getEventPrefix, P as Pipeline, c as createStylesheetElementSet, b as createModuleScriptElement, L as Logger, A as AstroIntegrationLogger, d as createDefaultRoutes, e as createAssetLink, a as apply } from './polyfill_DEZqtXao.mjs';
import { Http2ServerResponse } from 'node:http2';
import { r as removeTrailingForwardSlash, p as prependForwardSlash, j as joinPaths, a as appendForwardSlash, d as isInternalPath, e as collapseDuplicateTrailingSlashes, h as hasFileExtension } from './path_B8bFpEHO.mjs';
import { m as matchPattern } from './index_CZWCDbwp.mjs';
import { f as findRouteToRewrite, v as validateAndDecodePathname, m as matchRoute, n as normalizeTheLocale, R as RenderContext, P as PERSIST_SYMBOL, g as getSetCookiesFromResponse } from './index_DZXswOzt.mjs';
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_Cy1U53ZO.mjs';
