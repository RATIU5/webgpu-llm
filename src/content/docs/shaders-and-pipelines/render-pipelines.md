...
const fragmentShader: TgpuFragmentFn = (worldNormal: vec3f, uv: vec2f) => {
...
const fragmentShader = tgpu.fragmentFn((color: vec3f) => {
...
// Create vertex data
const vertices = new Float32Array([
  0.0, 0.5, 0.0, 1.0, 0.0, 0.0, -0.5, -0.5, 0.0, 0.0, 1.0, 0.0, 0.5, -0.5, 0.0,
  0.0, 0.0, 1.0,
]);
